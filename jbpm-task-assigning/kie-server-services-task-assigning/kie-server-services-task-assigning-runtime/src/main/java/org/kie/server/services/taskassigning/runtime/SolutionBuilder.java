...
import org.kie.server.services.taskassigning.runtime.util.UserUtil;
...
public class SolutionBuilder {
    ...
    public TaskAssigningSolution build() {
        ...
        final Map<String, List<AssignedTask>> assignedTasksByUserId = new HashMap<>();
    ...
    static void addTaskToUser(Map<String, List<AssignedTask>> tasksByUser,
                              Task task,
                              String actualOwner,
                              int index,
                              boolean pinned) {
    ...
    static void addInOrder(List<AssignedTask> assignedTasks,
                           Task task,
                           int index) {
