...
KIE_SERVER_DIST=/home/wmedvede/development/projects/droolsjbpm/droolsjbpm-integration/kie-server-parent/kie-server-wars/kie-server/target/kie-server-$VERSION-ee7.war
