...
public class SolverHandlerContext {
    ...
    public boolean hasMinimalDistance(LocalDateTime lastQueryTime, LocalDateTime nextQueryTime) {
        ...
        long lastQueryTimeMillis = lastQueryTime.atZone(ZoneOffset.systemDefault()).toInstant().toEpochMilli();
        long nextQueryTimeMillis = nextQueryTime.atZone(ZoneOffset.systemDefault()).toInstant().toEpochMilli();
